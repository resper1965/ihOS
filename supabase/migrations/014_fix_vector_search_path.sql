-- Fix pgvector operator resolution for match_documents_hybrid
-- The vector extension is in 'extensions' schema, so we need to 
-- set the search_path of the function to include it.
-- We drop and recreate to avoid ALTER-based issues.
