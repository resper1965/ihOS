...
const KEYWORD_RULES: KeywordRule[] = [
  {
    ...
    keywords: [
      ...
      // PT-BR
      'privacidade', 'dados pessoais', 'titular de dados',
      'consentimento', 'transferência de dados', 'encarregado',
      'base legal', 'tratamento de dados', 'direito ao esquecimento',
    ],
    weight: 2,
  },
  {
    ...
    keywords: [
      ...
      // PT-BR
      'incidente', 'monitoramento', 'auditoria',
      'detecção', 'contenção', 'evidência',
      'critérios de confiança', 'operações de segurança',
    ],
    weight: 2,
  },
  {
    ...
    keywords: [
      ...
      // PT-BR
      'executivo', 'resumo', 'diretoria', 'conselho',
      'impacto no negócio', 'estratégico', 'investimento',
      'postura de risco', 'visão geral', 'orçamento',
  ...
  },
  {
    ...
    keywords: [
      ...
      // PT-BR
      'documento', 'evidência', 'carregar', 'analisar', 'arquivo',
      'política', 'procedimento', 'atestação',
      'análise de gaps', 'revisão de documento', 'qualidade',
      'biblioteca de documentos', 'expirado', 'renovação',
    ],
    weight: 2,
  },
];
