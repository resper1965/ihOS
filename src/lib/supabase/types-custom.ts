// Custom types for ihOS Supabase schema
// These are manually maintained types that complement the auto-generated Database interface.
// The Database type itself lives in types.generated.ts (run `npx supabase gen types typescript`).
