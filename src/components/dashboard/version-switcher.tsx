    ...
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <div className="flex flex-col items-start leading-tight">
          ...
          <span className="font-medium truncate max-w-[120px] text-text-primary">
          ...
          <div className="p-1 space-y-1 max-h-80 overflow-y-auto">
            ...
            >
              <div className="flex items-center justify-between font-semibold">
                ...
                <span className="rounded bg-black/5 dark:bg-white/10 px-1 py-0.5 text-[8px] uppercase tracking-wider text-text-muted">Organization</span>
              </div>
            ...
            {versions.map((v) => {
              ...
              const statusColors = {
                ...
                deprecated: "bg-red-500/20 text-red-500 border-red-500/30",
              };
